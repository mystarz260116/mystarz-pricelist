  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: '補強線', price: '1,200' },
        { name: 'キャスト保持装置', price: '510' },
        { name: 'CRC', price: '1,800' },
        { name: 'CC', price: '1,800' },
        { name: 'キャスト単鉤', price: '1,800' },
        { name: 'キャスト双子鉤', price: '2,000' },
        { name: 'キャストレスト', price: '900' },
        { name: 'キャストバー', price: '3,500' },
        { name: 'WRC', price: '1,400' },
        { name: 'ワイヤー双子鉤', price: '2,000' },
        { name: 'ワイヤー単鉤', price: '1,100' },
        { name: 'コンビネーションクラスプ', price: '2,200' },
      ]
    },
    {
      ...
      color: 'blue',
      items: [
        { name: '配列 1~4歯 (レジン/熱可塑)', price: '800 / 800' },
        { name: '配列 5~8歯 (レジン/熱可塑)', price: '1,200 / 1,200' },
        { name: '配列 9~11歯 (レジン/熱可塑)', price: '1,500 / 1,500' },
        { name: '配列 12~14歯 (レジン/熱可塑)', price: '1,500 / 2,000' },
        { name: '配列 総義歯 (レジン/熱可塑)', price: '2,000 / 2,800' },
        ...
        { name: '完成 総義歯 (レジン/熱可塑)', price: '15,000 / 15,000' },
      ]
    },
    {
