...
const PriceListRenderer: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className="flex flex-col gap-0 items-center py-0 print:block w-full">
      ...
      {/* PAGE 1: FRONT COVER & IMPLANT - 見切れ解消版 */}
      <div className="responsive-a4-wrapper">
        <div className="a4-page p-12 flex flex-col h-full bg-white">
          ...
          <div className="w-full text-center border-y-[3px] border-gray-800 py-8 mb-6 mt-2">
               ...
               <div className="mb-4">
                 ...
                 <div className="border-[3px] border-[#ea580c] bg-white overflow-hidden rounded-b shadow-lg">
                   {implantCat.items.map((item, idx) => (
                     <div key={idx} className={`flex justify-between px-8 py-1 text-[10.8px] border-b border-[#fff7ed] last:border-0 ${idx % 2 === 0 ? 'bg-white' : 'bg-[#fff7ed]'}`}>
                       <span className="flex-1 font-bold text-gray-800 leading-tight py-0.5">{sanitizeName(item.name)}</span>
                       <span className="w-40 text-right font-black text-[#9a3412] leading-tight text-[11.5px] py-0.5">¥ {item.price}</span>
                     </div>
                   ))}
                 </div>
          ...
          {/* Footer area - NO BLACK BAR */}
          <div className="w-full mt-auto pt-6 pb-2 border-t-[2px] border-gray-100">
             ...
             <div className="text-center text-[8.5px] text-gray-500 font-bold mb-2 leading-relaxed">
               〒569-0806　高槻市明田町4-38 太陽ファルマテック株式会社内<br/>
               <span className="text-xs font-black tracking-widest text-blue-900">FAX 072-691-7108</span>
             </div>
             <div className="w-full border-t-[2px] border-gray-800 pt-1.5 text-center">
               <div className="text-md font-black text-gray-800 tracking-[0.5em]">株式会社マイ・スターズ 大阪</div>
             </div>
          </div>
        </div>
      </div>

      {/* PAGE 2: Insurance Prices - 維持 */}
      <div className="responsive-a4-wrapper">
      ...
      <div className="responsive-a4-wrapper">
        <div className="a4-page p-10 flex flex-col text-gray-800 bg-white">
            ...
            <div className="w-1/2">
              ...
              <div className="border-[2px] border-[#ea580c] bg-white rounded-b overflow-hidden shadow-sm">
                {privateGishiBasic?.items.slice(0, 5).map((item, i) => (
                  <div key={i} className={`flex justify-between px-3 py-1.5 text-[10.5px] border-b border-[#fff7ed] last:border-0 font-bold ${i % 2 !== 0 ? 'bg-[#fff7ed]' : ''}`}>
          ...
          <div className="mb-5">
            ...
            <div className="flex flex-row gap-3 border-[2px] border-[#ea580c] bg-white p-3 rounded-b shadow-sm">
              <div className="w-1/2">
          ...
          <div className="mt-auto pt-3">
            <div className="flex flex-row gap-6">
               ...
               <div className="w-1/2">
                 ...
                 <div className="border-[2px] border-[#ea580c] bg-white p-3 rounded-b text-[10px] space-y-1.5 font-black shadow-sm flex flex-col min-h-[130px]">
